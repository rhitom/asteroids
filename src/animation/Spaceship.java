...
public class Spaceship {
    ...
    public static void shoot() {
        ...
        for (int i = 0; i < Game.shipBullets.size(); i++) {
            if ((Game.shipBullets.get(i) != null)
                    && !(Game.shipBullets.get(i).collided)) {
     ...
     */
    public static boolean checkShipAsteroidCollision(Asteroid asteroid,
            Spaceship spaceship, boolean inBounds) {
     ...
     * @return true, if the shapes intersect
     */
    public static boolean checkShipBulletCollision(Spaceship spaceship,
            Bullet saucerBullet, boolean inBounds) {
	...
	/**
	 * Checks if Spaceship is dead using numLives
	 * @return true if numLives is 0, else false
	 */
