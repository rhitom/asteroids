...
class SpaceshipTest {
	...
	//		int y = spaceship.getY();
	//		
	//		spaceship.backward(game.getAccelerationValue());
	//		
	//		assertTrue((spaceship.getY() >= y));
	//	}

	/*
	 * Purpose: Test correct use of rotateL()
	 * Initialization: radians to hold starting radian value
	 * Correct result: getRadians() is not equal to radians
	 */
	@Test
	void testRotateL() {
